...
a certain algorithm, but I had only used git personal projects, or projects with only two other collaborators (minimal
...
I think many of us have this idea in our heads that in order to take on a job, we should be 100% perpared and we should
...
day _shortened_ my workday. Maybe not immediately, but over time. Intead of reading documentation or resources that
...
Speaking of questions, I tried to adopt an idea of always asking the stupid question. I often preface these types of
questions with "this is probably a stupid question", or some other variation of the sentiment, to which my coworkers
would reply "there's no such thing as a stupid question". Most believe this to be true, but I do believe that there is
...
If I couldn't or got stuck, I would reach out to some to ask a question or for help.
...
sub-problems made tasks feel way less overwhelming and ultimately get solved quicker. This can be demostrated in metaphor.
...
software, and technology is so vast that it is phyiscally impossible to retain all information about every individual
subfield.
...
#### A Side Note about Being a Women in Technology
...
Everything that is difficult about dealing with Imposter Syndrome is exasterbated immensely by simply being a women in
this field.

I'm not implying that _only_ women struggle with imposter syndrome, rather, it's much more likely that a women
