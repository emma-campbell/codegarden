...
const BLOCK =
  "overflow-hidden rounded-lg bg-white/5 shadow-surface-elevation-low ring-1 ring-white/[3%] ring-inset";
const TITLE =
  "mb-0.5 rounded-md bg-white/10 px-3 py-1 font-mono text-xs text-white/70 shadow-sm";
...
const INLINE_BLOCK =
  "whitespace-nowrap border border-white/10 px-1.5 py-px text-[12px] rounded-full bg-white/5 whitespace-nowrap text-white/90";
const INLINE_CODE = "";
...
const HIGHLIGHTED_LINE = "!border-l-white/70 bg-white/10 before:!text-white/70";
