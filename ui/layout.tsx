...
export const Layout: FC<LayoutProps> = ({
  ...
  return (
    <>
      <main className="relative z-10 mx-4 mobile-lg:mx-12 tablet:mx-24 laptop:mx-36 desktop:mx-72 desktop-xl:mx-96 desktop-2xl:mx-128 pt-10 tablet:pt-12 laptop:pt-20 desktop:pt-20 desktop-xl:pt-20 desktop-2xl:pt-20 text-white">
